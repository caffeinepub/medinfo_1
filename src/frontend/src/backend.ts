...
export class Backend implements backendInterface {
    ...
    async getFeaturedMedicines(): Promise<Array<Medicine>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFeaturedMedicines();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMedicineByBarcode(arg0: string): Promise<Medicine> {
        if (this.processError) {
            try {
                const result = await this.actor.getMedicineByBarcode(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
